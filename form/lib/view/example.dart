      ...
      body: Center(
        child: Column(
          children: [
            ...
            const Column(
              children: [
                Text("Please enter code that we've sent to", style: TextStyle(color: Colors.grey,fontSize:15)),
                SizedBox(height: 10),
                Text("c*********@gmail.com",style: TextStyle(fontSize:15, fontWeight: FontWeight.bold)),
                SizedBox(height: 30),
              ],
            ),
            ...
            const Text("Didn't you receive any code?", style: TextStyle(color: Colors.grey,fontSize:13)),
            const SizedBox(height: 20),
            const Text("RESEND CODE", style: TextStyle(color: Colors.red,fontSize:15, fontWeight: FontWeight.bold)),
